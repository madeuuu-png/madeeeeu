...
export default function Index() {
  ...
  const { cedula, setCedula, cargando, handleLogin } = useAuth();
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.content}>
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.description}>Ingresa tu cédula para continuar</Text>

            <View style={styles.inputContainer}>
              <CreditCard color="#EC407A" size={24} style={styles.inputIcon} />
              <TextInput
                style={styles.input}
            ...
            <TouchableOpacity
              ...
              disabled={cargando}
            >
              <Text style={styles.buttonText}>{cargando ? 'Verificando...' : 'Ingresar'}</Text>
